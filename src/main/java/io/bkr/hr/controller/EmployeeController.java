...
import io.bkr.hr.entity.Employee;
import io.bkr.hr.repository.EmployeeRepository;
import io.bkr.hr.utils.ResourceNotFoundException;
...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> getEmployeeById(
        ...
        Employee employee = employeeRepository
                .findById(employeeId)
                .orElseThrow(() -> new ResourceNotFoundException("Eployee not found for this id :: " + employeeId));
